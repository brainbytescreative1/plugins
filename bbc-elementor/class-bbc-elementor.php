...
/**
 * Main BBC Elementor Class
 *
 * The init class that runs the BBC Elementor plugin.
...
final class BBC_ELEMENTOR {
	...
	public function i18n() {
		load_plugin_textdomain( 'bbc-elementor' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( BBC_ELEMENTOR ) );
